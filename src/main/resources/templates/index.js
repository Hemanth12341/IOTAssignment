var app = new Vue({ 
    ...
    button: function() {
    	this.failureMessage =''
    	axios.get("./equipmentService/equipment/"+this.number)
    ...
    lists: function() {
    	this.failureMessage =''
    	axios.get("./equipmentService/equipment/search/"+this.limit)
        .then(response => {
    ...
    posts:function() {
    	...
    	axios.post("./equipmentService/equipment", this.equipment, { headers: {
